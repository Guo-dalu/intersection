import { c as create_ssr_component, a as compute_rest_props, b as spread, e as escape_object, d as escape_attribute_value, f as add_attribute, v as validate_component } from "../../chunks/ssr.js";
...
const DarkMode = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.size === void 0 && $$bindings.size && size !== void 0)
    $$bindings.size(size);
  return `${$$result.head += `<!-- HEAD_svelte-7ajg2y_START --><script data-svelte-h="svelte-1gvqq2n">localStorage.getItem('color-theme') === 'dark' ||
    (!('color-theme' in localStorage) && window.matchMedia('(prefers-color-scheme: dark)').matches)
      ? window.document.documentElement.classList.add('dark')
      : window.document.documentElement.classList.remove('dark');<\/script><!-- HEAD_svelte-7ajg2y_END -->`, ""} <button${spread(
    [
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<main class="py-3 px-6 md:px-10">${validate_component(DarkMode, "DarkMode").$$render($$result, { class: "absolute right-6 md:right-10" }, {}, {})} ${slots.default ? slots.default({}) : ``}</main>`;
});
export {
  Layout as default
};
